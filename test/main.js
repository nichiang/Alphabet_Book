...
var roleArn = 'arn:aws:iam::636458335557:role/ask-alphabet-book-debug';
...
sts.assumeRole({
    ...
    if (err) { // an error occurred
        ...
        var lambda = require('../lambda/us-east-1_ask-alphabet-book/index.js');
        var event = require('./guess-e.json');
